/**
 * The WhatsApp glyph, drawn as a filled path so it reads correctly at the
 * small sizes it is used at.
 *
 * `currentColor` throughout rather than WhatsApp's brand green: on this site
 * it sits inside marigold links and dark bands, and a stamp of #25D366 would
 * be the loudest thing on the page. The shape alone is recognisable.
 */
