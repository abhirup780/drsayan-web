...
<Callout title="Watch instead of read">

Two recorded talks cover the same ground for families who would rather hear it: **Diabetes in Children**, an introduction for parents who have just had the diagnosis, and **Diabetic Ketoacidosis in Children: A Silent Emergency**, on the warning signs that mean go to hospital now.

Both are on the [Media page](/media).
